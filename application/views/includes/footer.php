        ...
        <script type="text/javascript" src="<?php echo base_url(); ?>assets/plugins/datatables-bs5/js/dataTables.bootstrap5.min.js"></script>
        ...
        <!-- JS - DATATABLES - SEARCH_BUILDER -->
        <script type="text/javascript" src="<?php echo base_url(); ?>assets/plugins/datatables-searchbuilder/js/dataTables.searchBuilder.js"></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>assets/plugins/datatables-searchbuilder/js/searchBuilder.bootstrap5.min.js"></script> <!-- EN LA WEB NO ESTÀ! actualment s'està utilitzant el de BT4! -->
        ...
        <script type="text/javascript" src="<?php echo base_url(); ?>assets/plugins/datatables-buttons/js/buttons.bootstrap5.min.js"></script>
