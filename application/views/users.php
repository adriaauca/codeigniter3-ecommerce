...
?>
    <div class="container">
            ...
            <form method="POST" action="<?php echo base_url(); ?>users/update">
                <div class="card-body">
                    <div class="row my-2">
                        ...
                        <div class="col-6">
                            <input type="text" name="name" id="name" class="form-control form-control-sm" placeholder="New Username Name" autocomplete="off">
                        </div>
                    </div>
                    <div class="row my-2">
                        <div class="col-6">
                            <input type="text" name="email" id="email" class="form-control form-control-sm" placeholder="New Email" autocomplete="off">
                        </div>
                        <div class="col-6">
                            <input type="password" class="form-control form-control-sm" name="password" placeholder="New Password" autocomplete="off">
                        </div>
                    </div>
                    <div class="row my-2">
        ...
        <div class="row mb-4">
            <h4 class="mb-3">Search <button type="button" class="btn btn-secondary" onclick="insertButtons('Users')">Buttons</button></h4>
            <div class="col-12">
                <div class="card-body">
