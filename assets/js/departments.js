...
{
  if (confirm("Are you sure you want to permanently remove this department?"))
  {
    $.post( "Departments/destroy", {id: id}, function()
    {
...
$(document).ready(function ()
{
  ...
  var Departments = $("#Departments").DataTable({
      ajax: {
          url: baseURL + "Departments/show_all",
          type: "GET",
          error: function (err) {
              console.log(err);
      ...
      columns: [
          ...
          },
          {
            ...
            mRender: function (data, type, full)
            {
              return '<button type="button" class="btn btn-danger" onclick="deleteRow(' + full["id"] + ')" >Delete</button>';
            },
            type: "string",
          }
      ],
          ...
          buttons: [
              ...
              },
              {
                  ...
                  customize: function (xlsx) {
                      ...
                      var filters = $("#Departments").DataTable().searchBuilder.getDetails();
                      var result = "";
                      var depth = 0;
